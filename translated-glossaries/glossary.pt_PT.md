...
- **Significado**: O descritor técnico do que constitui um grupo de povos
  ...
  página de Definições.
- **Porque importa**: Os tradutores devem compreender que este é o conceito
  subjacente, para escolherem palavras orientadas para a etnicidade e a
  língua, e não palavras políticas.
...
- **Definição do sítio**: "Uma multiplicação de igrejas indígenas que
  ...
  Definições)
- **Exemplo**: "Movimentos de plantação de igrejas entre cada povo não
  alcançado na terra" (meta da página inicial)
- **Porque importa**: "Movimento" implica impulso auto-multiplicador, não
  uma única plantação de igreja ou programa. As métricas (4 correntes ×
  4 gerações × 1 000 pessoas) devem ser traduzíveis; evitar formulações
  que soem a movimento social ou político.
...
- **Porque importa**: "Apostólico" significa aqui enviado/pioneiro, não um
  título denominacional. O parêntesis "(pioneiro)" sinaliza isso; manter
  essa clareza na tradução.

---

### Trabalho pioneiro

- **Significado**: A fase inicial de evangelização entre um povo de
  fronteira onde não existem crentes para começar.
- **Exemplo**: "O trabalho pioneiro geralmente deve começar com não-crentes"
  (página de Definições)
- **Porque importa**: Os tradutores devem transmitir a ideia de "começar
  do zero" em termos de presença evangélica.

---

### Língua do coração

- **Significado**: A primeira língua/língua materna de uma pessoa — a
  língua na qual pensa e sente com maior profundidade.
- **Exemplo**: "Compromisso de trabalhar na cultura local e na língua do
  coração" (página de Definições)
- **Porque importa**: Uma expressão missionária bem estabelecida. Distinguir
  de "língua oficial" ou "língua franca". O conceito é que o trabalho de
  evangelismo e discipulado deve ocorrer nesta língua para ser plenamente
  eficaz.
...
- **Porque importa**: A lógica matemática deve ser traduzível. Evitar que
  "cobertura" seja lida como seguro ou cobertura legal; significa *oração
...
### A oração prepara o caminho

- **Significado**: Uma convicção teológica de que a intercessão cria
  condições espirituais para avanços do evangelho antes mesmo de os
  trabalhadores chegarem.
- **Exemplo**: "A oração amolece corações, abre portas e convida a obra
...
- **Significado**: O cabeçalho da visão geral na interface, referindo-se
  às metas de 2033 listadas na página de Visão.
- **Exemplo**: "Visão 2033" (cabeçalho da página inicial)
- **Porque importa**: Uma etiqueta de nome próprio para o conjunto de metas
  da iniciativa. Manter o ano intacto.
...
- **Exemplo**: "Jesus é digno de glória de toda tribo, língua, povo e
  nação." (página Sobre Nós — Sending Summit Declaration)
- **Porque importa**: Alinhar com a tradução bíblica estabelecida na língua
  de destino. Os quatro substantivos são teologicamente intencionais —
  tribo (clã/família), língua (idioma), povo (grupo étnico), nação (unidade
  política) — cada um captando uma dimensão diferente da diversidade humana.
...
## 6. Igreja, discipulado e termos teológicos

---

### Discípulo / discípulos (como métrica)
...
- **Porque importa**: "Batizados" é um qualificador que distingue a
  afiliação nominal da pertença genuína.
...
- **Porque importa**: Linguagem de contextualização — deve transmitir
  adaptação à cultura sem implicar compromisso do evangelho.
...
### Gerações espirituais (de igrejas)

- **Significado**: O número de "gerações" de plantação de igrejas que um
  MPI produziu (A planta B, B planta C, C planta D = 4 gerações).
- **Exemplo**: "quatro correntes de quatro gerações espirituais" (página
  de Definições)
- **Porque importa**: Uma métrica técnica do MPI. Os tradutores devem
  transmitir linhagem multiplicativa, não a idade dos crentes.

---

### Permanecer em Jesus

- **Significado**: Valor central de João 15:5 — permanecer em relação
  contínua e dependente com Jesus como fonte de todo o fruto.
- **Exemplo**: "Permanecer em Jesus (João 15:5)" (página de Visão — Valores)
- **Porque importa**: "Permanecer" tem um sentido relacional e contínuo.
  Evitar traduzi-lo como um acto passado único ou uma localização física.

---

### Orar sem cessar

- **Significado**: Valor central de 1 Tessalonicenses 5:17 — a postura
  de oração contínua e habitual subjacente a toda a visão de oração do
  Doxa.Life.
- **Exemplo**: "Orai sem cessar (1 Tessalonicenses 5:17)" (página de Visão)
- **Porque importa**: Usar a expressão estabelecida da tradução bíblica.
  Enfatizar a continuidade, não a impossibilidade literal.

---

### Nega-te a ti mesmo

- **Significado**: Valor central de Lucas 9:23 — a auto-renúncia voluntária
  enquanto os discípulos seguem Jesus na missão.
- **Exemplo**: "Nega-te a ti mesmo (Lucas 9:23)" (página de Visão — Valores)
- **Porque importa**: Transmitir a auto-renúncia voluntária por causa de
  Cristo, não o auto-ódio ou o ascetismo.
...
## 7. Termos organizacionais e estruturais
...
- **Porque importa**: Manter como nome próprio. Pode acrescentar-se uma
  breve nota explicativa (p.ex., "DOXA = glória em grego") onde o nome
  é introduzido pela primeira vez, mas não o traduzir.
...
- **Porque importa**: Um nome próprio de documento; manter tal qual ou
  acrescentar um breve descritor entre parêntesis.
...
- **Porque importa**: Cada qualificador ("voluntária", "global", "receptora")
  é teológica e estruturalmente intencional. "Receptora" distingue-a
  especificamente de ser uma agência de envio.
...
- **Significado**: A tradição e distinção teológica da WAGF/Assembleias
  de Deus, tal como indicado na introdução da Declaração de Fé.
- **Exemplo**: "A verdade aqui exposta é considerada essencial para um
  ministério verdadeiramente Pentecostal." (Declaração de Fé)
- **Porque importa**: Uma designação teológica própria — manter como
  "Pentecostal" (é amplamente utilizado como empréstimo linguístico em
  muitas línguas).

---

## 8. Termos da Declaração de Fé (teológicos)
...
| Termo | Nota breve |
|-------|-----------|
| **Novo nascimento** | Conversão/regeneração — "nascer de novo" (João 3:5–6) |
| **Regeneração** | A obra do Espírito Santo de renovação espiritual na salvação |
