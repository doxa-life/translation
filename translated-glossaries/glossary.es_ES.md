...
preservar esos umbrales íntegros.
...
- **Por qué importa**: El umbral (≤ 2%) debe reproducirse en la traducción.
  ...
  importante como el porcentaje. Evitar redacciones que impliquen que el grupo
  es espiritualmente "no elegido" o socialmente marginal.
...
- **Por qué importa**: Los traductores deben entender que este es el concepto
  subyacente, para elegir palabras orientadas a la etnicidad y al idioma, no
  palabras políticas.
...
- **Por qué importa**: "Acceso" implica disponibilidad y accesibilidad, no
  solo presencia geográfica. Traducir como "conocimiento del evangelio" u
  "oír el evangelio" cambia el significado de manera sutil pero importante.
...
- **Por qué importa**: "Movimiento" implica impulso de auto-multiplicación, no
  ...
  suenen como un movimiento social o político.
...
- **Por qué importa**: "Apostólico" aquí significa enviado/pionero, no un
  título denominacional. El paréntesis "(pionero)" señala esto; mantener esa
...
- **Por qué importa**: Los traductores deben transmitir la idea de "comenzar
  desde cero" en términos de presencia del evangelio.
...
- **Ejemplo**: "Compromiso de trabajar en la cultura local y en el idioma del
  corazón" (página de Definiciones)
- **Por qué importa**: Una frase misional bien establecida. Distinguir de
  "idioma oficial" o "lengua franca". El concepto es que el trabajo de
  evangelio y discipulado debe ocurrir en este idioma para ser plenamente
  eficaz.
...
- **Por qué importa**: Ayuda a las personas a comprender que pueden participar
  en la misión incluso sin ir al campo.
...
- **Por qué importa**: La lógica matemática debe ser traducible. Evitar que
  ...
  ininterrumpida a lo largo del día*.
...
- **Por qué importa**: Usar el término eclesiástico establecido para intercesor
  / guerrero de oración, no una connotación judicial o gubernamental.
...
- **Significado**: Una convicción teológica de que la intercesión crea
  condiciones espirituales para avances del evangelio antes de que los obreros
  siquiera lleguen.
- **Ejemplo**: "La oración ablanda corazones, abre puertas e invita la obra
...
- **Significado**: Los tres pilares de la adopción — oración intercesora, apoyo
  financiero y envío de obreros.
- **Ejemplo**: "Las iglesias y redes asumen la responsabilidad — orando, dando
  y preparando el camino para los obreros del evangelio." (página de inicio);
  "Asociarse mediante la oración, las donaciones y el envío" (página de
  Adoptar)
- **Por qué importa**: Esta tríada se usa de manera consistente. Las tres
  acciones deben traducirse con verbos activos y participativos, no pasivos ni
  devocionales.
...
- **Significado**: Levantar y activar intercesores y participantes en una
  congregación o red.
- **Ejemplo**: "Levantar 144+ intercesores diarios" / "Herramientas para
  movilizar la oración y la participación en toda tu congregación" (página de
  Adoptar)
- **Por qué importa**: "Movilizar" implica movimiento activo hacia un objetivo.
  Evitar palabras pasivas como "informar" o "invitar".
...
- **Por qué importa**: Alinearse con la traducción bíblica establecida en el
  ...
  — tribu (clan/familia), lengua (idioma), pueblo (grupo étnico), nación
  (unidad política) — cada uno captando una dimensión diferente de la
  diversidad humana.
...
## 6. Iglesia, discipulado y términos teológicos

---

### Discípulo/a / discípulos (como métrica)
...
- **Ejemplo**: "Una iglesia está compuesta por discípulos bautizados unidos por
  ...
  (definición de UPG)
- **Por qué importa**: Usar la palabra cristiana establecida para discípulo,
  no "estudiante", "seguidor" (genérico) ni "converso". El uso de la métrica
  numérica debe permanecer conectado a este significado teológico.

---

### Discípulos bautizados

- **Significado**: La definición formal de membresía eclesiástica en Doxa.Life
  — personas que han seguido a Jesús en el bautismo de creyentes y están
  unidas por el Espíritu Santo.
- **Ejemplo**: "Una iglesia está compuesta por discípulos bautizados unidos por
  el Espíritu Santo" (página de Definiciones)
- **Por qué importa**: "Bautizados" es un calificativo que distingue la
  afiliación nominal de la membresía genuina.

---

### Haced discípulos a todas las naciones

- **Significado**: El mandato de la Gran Comisión de Mateo 28:19, citado en la
  sección de Misión.
- **Ejemplo**: "Para la gloria de Dios, hacer discípulos a todas las naciones
  yendo, bautizando y enseñando." (página de Visión — Misión)
- **Por qué importa**: Alinearse con la traducción bíblica de confianza local.
  "Naciones" aquí significa pueblos étnicos, no países.
...
- **Por qué importa**: Lenguaje de contextualización — debe transmitir
  adaptación a la cultura sin implicar compromiso del evangelio.

---

### Iglesias autosustentables
...
### Generaciones espirituales (de iglesias)

- **Significado**: El número de "generaciones" de plantación de iglesias que
  un MPI ha producido (A planta B, B planta C, C planta D = 4 generaciones).
- **Ejemplo**: "cuatro corrientes de cuatro generaciones espirituales" (página
  de Definiciones)
- **Por qué importa**: Una métrica técnica de MPI. Los traductores deben
  transmitir linaje multiplicativo, no la edad de los creyentes.

---

### Permanecer en Jesús

- **Significado**: Valor central de Juan 15:5 — permanecer en relación
  continua y dependiente con Jesús como fuente de toda fructificación.
- **Ejemplo**: "Permanecer en Jesús (Juan 15:5)" (página de Visión — Valores)
- **Por qué importa**: "Permanecer" conlleva un sentido relacional y continuo.
  Evitar traducirlo como un acto pasado único o una ubicación física.

---

### Orar sin cesar

- **Significado**: Valor central de 1 Tesalonicenses 5:17 — la postura de
  oración continua y habitual que subyace a toda la visión de oración de
  Doxa.Life.
- **Ejemplo**: "Orad sin cesar (1 Tesalonicenses 5:17)" (página de Visión)
- **Por qué importa**: Usar la frase establecida de la traducción bíblica.
  Enfatizar la continuidad, no la imposibilidad literal.

---

### Niégate a ti mismo

- **Significado**: Valor central de Lucas 9:23 — la auto-renuncia voluntaria
  mientras los discípulos siguen a Jesús en la misión.
- **Ejemplo**: "Niégate a ti mismo (Lucas 9:23)" (página de Visión — Valores)
- **Por qué importa**: Transmitir la auto-renuncia voluntaria por causa de
  Cristo, no el auto-odio ni el ascetismo.

---

### Involúcrate en las regiones más allá

- **Significado**: Valor central de 2 Corintios 10:16 — alcanzar más allá de
  donde el evangelio ya ha llegado.
...
## 7. Términos organizacionales y estructurales

---

### DOXA

- **Significado**: La palabra griega para "gloria" — el nombre de la iniciativa
  que enfatiza que el objetivo de la misión es la gloria de Dios, no el logro
  humano.
- **Ejemplo**: "DOXA es la palabra griega para 'GLORIA'." (página de inicio)
- **Por qué importa**: Mantener como nombre propio. Se puede añadir una breve
  nota explicativa (p. ej., "DOXA = gloria en griego") donde se presente el
  nombre por primera vez, pero no traducirlo.
...
- **Por qué importa**: Es el nombre propio de un documento; mantener tal cual
  o añadir un breve descriptor entre paréntesis.

---

### Asociación Voluntaria, Global y Receptora

- **Significado**: Cómo DOXA se describe a sí misma — las agencias miembro
  participan por elección, abarca el mundo y recibe/coordina misioneros en
  lugar de enviarlos directamente.
- **Ejemplo**: "Formaremos una Asociación Voluntaria, Global y Receptora"
  (Sending Summit Declaration)
- **Por qué importa**: Cada calificativo ("voluntaria", "global", "receptora")
  es intencional desde el punto de vista teológico y estructural. "Receptora"
  la distingue específicamente de ser una agencia enviadora.
...
- **Por qué importa**: Usar el término eclesiástico establecido para
  ...
  palabras con connotación legal.
...
- **Por qué importa**: Es una designación teológica propia — mantener como
  "Pentecostal" (es ampliamente utilizado como préstamo lingüístico en muchos
  idiomas).

---

## 8. Términos de la Declaración de Fe (teológicos)

Estos términos aparecen específicamente en la página de la Declaración de Fe.
Son vocabulario doctrinal estándar. Los traductores deben usar equivalentes
cristianos establecidos en el idioma de destino en lugar de inventar nuevas
traducciones.

| Término | Nota breve |
|---------|-----------|
| **Nuevo nacimiento** | Conversión/regeneración — "nacer de nuevo" (Juan 3:5–6) |
| **Regeneración** | La obra del Espíritu Santo de renovación espiritual en la salvación |
| **Justificación** | Ser declarado justo ante Dios por la fe en Cristo |
| **Expiación** | La muerte sustitutoria de Cristo que cubre el pecado de la humanidad |
| **Santificación** | Separación continua del mal y dedicación a Dios |
| **Bautismo en agua** | Bautismo de creyentes por inmersión (Mateo 28:19; Hechos 10:47–48) |
| **Cena del Señor / Comunión** | La ordenanza del pan y la copa (Lucas 22:14–20) |
| **Bautismo en el Espíritu Santo** | Una experiencia distinta de empoderamiento, evidenciada por hablar en lenguas |
| **Hablar en lenguas** | La evidencia inicial del bautismo en el Espíritu Santo |
| **Dones del Espíritu Santo** | Dones sobrenaturales (1 Corintios 12) |
| **Retorno premilenial** | El retorno inminente, personal y corporal de Cristo antes del milenio |
| **Resurrección corporal** | Resurrección física de toda la humanidad al final de los tiempos |

---

## 9. Etiquetas de navegación y de acción

Estos términos de nivel de interfaz aparecen como títulos de página, etiquetas
de botones y frases de llamada a la acción. La coherencia en la traducción es
fundamental para la usabilidad.

| Etiqueta | Contexto | Nota de traducción |
|----------|---------|-------------------|
...
## Resumen: términos clave confirmados

Los once términos clave especificados por el equipo del proyecto fueron
encontrados en el contenido del sitio y se incluyen arriba con definiciones y
