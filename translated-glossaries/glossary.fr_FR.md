...
traductions doivent reproduire ces seuils intégralement.
...
- **Pourquoi c'est important** : Le seuil (≤ 2 %) doit être reproductible
  dans la traduction. La notion d'*incapacité* à se propager de façon autonome
  est aussi importante que le pourcentage. Éviter toute formulation qui
  laisserait entendre que le groupe est spirituellement « non élu » ou
...
- **Pourquoi c'est important** : « Frontière » (frontier) signale la pointe
  ...
  militaires là où elles seraient culturellement sensibles ; préserver le sens
  de « premier contact » avec l'Évangile.
...
- **Pourquoi c'est important** : Les traducteurs doivent comprendre que c'est
  le concept sous-jacent afin de choisir des termes orientés vers l'ethnicité
  et la langue, et non des termes politiques.

---

## 2. Langage de l'engagement et de la mission
...
- **Pourquoi c'est important** : « Accès » implique disponibilité et
  ...
  sens de façon subtile mais importante.
...
- **Pourquoi c'est important** : Il s'agit d'un cadre de référence standard en
  missiologie. Les traducteurs doivent utiliser les équivalents établis s'ils
  existent dans la langue cible ; sinon, chaque composé « auto- » nécessite un
  rendu cohérent.
...
- **Pourquoi c'est important** : « En résidence » par opposition à
  ...
  doivent pas niveler cette distinction en employant simplement
  « missionnaires ».
...
- **Pourquoi c'est important** : « Apostolique » signifie ici envoyé/pionnier,
  ...
  conserver cette clarté dans la traduction.
...
- **Pourquoi c'est important** : Expression bien établie en missiologie.
  ...
  cette langue pour être pleinement efficace.
...
- **Pourquoi c'est important** : Aide les gens à comprendre qu'ils peuvent
  participer à la mission même sans se rendre sur le terrain.
...
- **Pourquoi c'est important** : « Quotidien » est intentionnel et fait partie
  ...
  régulière » ou « prière occasionnelle ».
...
- **Pourquoi c'est important** : La logique mathématique doit être traduisible.
  Éviter que « couverture » soit compris comme une assurance ou une couverture
  juridique ; il s'agit d'une *prière ininterrompue tout au long de la journée*.
...
- **Pourquoi c'est important** : Distinguer de la prière dévotionnelle
  personnelle ; souligner la dimension *au nom d'autrui*.

---

### Guide de prière quotidien / points de prière quotidiens
...
- **Exemple** : « La prière attendrit les cœurs, ouvre des portes et invite
  l'œuvre du Saint-Esprit bien avant que les ouvriers arrivent ou que
  l'Évangile soit proclamé. » (Page Prier)
- **Pourquoi c'est important** : Expression motivationnelle clé qui explique
  pourquoi la prière est la première étape de l'engagement, et non un simple
  complément.
...
- **Signification** : Susciter et activer des intercesseurs et des participants
...
- **Exemple** : « Chaque département missionnaire affilié au World Assemblies
  of God Fellowship (129 agences d'envoi différentes au 1er janvier 2026) est
...
## 5. Langage de la vision et des objectifs
...
- **Pourquoi c'est important** : « Priorité » signale que c'est *l'objectif
  ...
  2033 doit être conservée exactement.

---

### Vision 2033

- **Signification** : Le titre de la vision dans l'interface, renvoyant aux
  objectifs de 2033 listés sur la page Vision.
- **Exemple** : « Vision 2033 » (titre de la page d'accueil)
- **Pourquoi c'est important** : Nom propre désignant l'ensemble des objectifs
  de l'initiative. Conserver l'année intacte.
...
- **Pourquoi c'est important** : S'aligner sur la traduction biblique établie
  ...
  ethnique), nation (entité politique) — chacun capturant une dimension
  différente de la diversité humaine.
...
- **Pourquoi c'est important** : « Partenariat » signale que ces missionnaires
  ...
  collaborent au sein du réseau.

---

## 6. Église, discipulat et termes théologiques

---

### Disciple / disciples (comme métrique)

- **Signification** : Des suiveurs de Jésus qui sont baptisés, rassemblés et
  capables de se reproduire. Utilisé comme unité de mesure pour les seuils
...
- **Signification** : La définition formelle de l'appartenance à l'église sur
  Doxa.Life — des personnes qui ont suivi Jésus dans le baptême du croyant et
  sont réunies par le Saint-Esprit.
- **Exemple** : « Une église est composée de disciples baptisés réunis par le
  Saint-Esprit » (page Définitions)
- **Pourquoi c'est important** : « Baptisés » est un qualificatif qui distingue
  l'appartenance nominale de l'appartenance véritable.

---

### Faire de toutes les nations des disciples

- **Signification** : Le mandat de la Grande Commission tiré de Matthieu 28:19,
  cité dans la section Mission.
- **Exemple** : « Pour la gloire de Dieu, faire de toutes les nations des
  disciples en allant, baptisant et enseignant. » (Page Vision — Mission)
- **Pourquoi c'est important** : S'aligner sur la traduction biblique de
  confiance dans la langue cible. « Nations » désigne ici les peuples
  ethniques, et non les pays.
...
- **Exemple** : « Le travail se déroule de manière culturellement appropriée et
  localement pertinente. » (Page Vision)
- **Pourquoi c'est important** : Langage de contextualisation — doit transmettre
  l'adaptation à la culture sans impliquer un compromis sur l'Évangile.

---

### Églises autonomes

- **Signification** : Des églises capables de se soutenir financièrement, de se
  reproduire et de se gouverner sans dépendance extérieure.
- **Exemple** : « Des efforts sont déployés pour établir des églises autonomes »
  (Page Vision — définition de l'engagement)
- **Pourquoi c'est important** : « Autonome » se distingue de « indépendant »
  — il implique une maturité saine, non un isolement.
...
- **Pourquoi c'est important** : Métrique technique d'un MPÉ. Les traducteurs
  doivent exprimer une filiation multiplicatrice, et non l'âge des croyants.
...
## 7. Termes organisationnels et structurels

---

### DOXA

- **Signification** : Le mot grec désignant la « gloire » — le nom de
  l'initiative souligne que le but de la mission est la gloire de Dieu, non la
  réussite humaine.
- **Exemple** : « DOXA est le mot grec pour "GLOIRE". » (Page d'accueil)
- **Pourquoi c'est important** : Conserver comme nom propre. Une brève note
  explicative (p. ex. « DOXA = gloire en grec ») peut être ajoutée là où le
  nom est introduit, mais ne pas le traduire.
...
- **Signification** : La fraternité mondiale qui a fondé et administre
  Doxa.Life. Comprend 129 agences d'envoi affiliées (au 1er janvier 2026).
...
### Commission des missions du WAGF

- **Signification** : L'organe de supervision au sein du WAGF qui nomme et
...
- **Signification** : La déclaration fondatrice signée à Lake Geneva, Minnesota,
  le 25 septembre 2025, par laquelle les agences affiliées au WAGF s'engagent
  dans le partenariat DOXA.
- **Exemple** : « SENDING SUMMIT DECLARATION » (titre de la page À propos)
- **Pourquoi c'est important** : Nom propre d'un document ; conserver tel quel
  ou ajouter un bref descripteur entre parenthèses.

---

### Partenariat volontaire, mondial et récepteur

- **Signification** : La façon dont DOXA se décrit — les agences membres y
  participent librement, il s'étend à l'échelle mondiale, et il
  reçoit/coordonne des missionnaires plutôt que de les envoyer directement.
- **Exemple** : « Nous formerons un Partenariat volontaire, mondial et
  récepteur » (Sending Summit Declaration)
- **Pourquoi c'est important** : Chaque qualificatif (« volontaire »,
  « mondial », « récepteur ») est théologiquement et structurellement
  intentionnel. « Récepteur » distingue spécifiquement ce partenariat d'une
  agence d'envoi.
...
- **Signification** : Le résumé doctrinal des convictions du WAGF, accessible
  sur doxa.life/about/statement-of-faith.
- **Pourquoi c'est important** : Utiliser le terme ecclésial établi pour
  « déclaration doctrinale » ou « confession de foi » dans la langue cible.
  Éviter les termes à connotation juridique.

---

### Pentecôtiste

- **Signification** : La tradition théologique et les spécificités du
  WAGF / Assemblées de Dieu, telles qu'énoncées dans l'introduction de la
  Déclaration de foi.
- **Exemple** : « La vérité exposée est considérée comme essentielle à un
  véritable ministère pentecôtiste. » (Déclaration de foi)
- **Pourquoi c'est important** : Désignation théologique propre — conserver
  « pentecôtiste » (largement utilisé comme emprunt dans de nombreuses
  langues).

---

## 8. Termes de la Déclaration de foi (théologiques)

Ces termes figurent spécifiquement dans la page Déclaration de foi. Il s'agit
d'un vocabulaire doctrinal standard. Les traducteurs doivent utiliser les
équivalents chrétiens établis dans la langue cible plutôt que d'en inventer
de nouveaux.

| Terme | Note succincte |
|-------|---------------|
...
## 9. Libellés de navigation et d'action

Ces termes de niveau interface apparaissent comme titres de page, libellés de
boutons et phrases d'appel à l'action. La cohérence de la traduction est
essentielle pour l'utilisabilité.
...
## Récapitulatif : termes fondateurs confirmés

Les onze termes fondateurs spécifiés par l'équipe du projet ont tous été
trouvés dans le contenu du site et figurent ci-dessus avec leurs définitions
et exemples spécifiques au site :
